...
/// <summary>
/// Tests for <see cref="TemporalConfiguration"/>.
/// </summary>
public class TemporalConfigurationTests
{
    ...
    public void Constructor_WithValidProperties_CreatesConfiguration()
    {
        ...
        var config = new TemporalConfiguration(validFromProp, validToProp);
    ...
    public void Constructor_ThrowsForNullValidFromProperty()
    {
        Assert.Throws<ArgumentNullException>(() =>
            new TemporalConfiguration(null!));
    }
    ...
    public void Constructor_WithOnlyValidFrom_IsOpenEnded()
    {
        ...
        var config = new TemporalConfiguration(validFromProp);
    ...
    {
        var config = TemporalConfiguration.Create<TestEntity>(
            e => e.ValidFrom,
            e => e.ValidTo);
    ...
    {
        var config = TemporalConfiguration.Create<TestEntityNonNullableValidTo>(
            e => e.ValidFrom,
            e => e.ValidTo);
    ...
    {
        var config = TemporalConfiguration.Create<TestEntity>("ValidFrom", "ValidTo");
    ...
    {
        var config = TemporalConfiguration.Create<TestEntity>("ValidFrom", null);
    ...
    {
        var config = TemporalConfiguration.Create<TestEntity>("ValidFrom", "");
    ...
    public void Create_WithInvalidValidFromProperty_ThrowsArgumentException()
    {
        Assert.Throws<ArgumentException>(() =>
            TemporalConfiguration.Create<TestEntity>("NonExistent", null));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            TemporalConfiguration.Create<TestEntity>("ValidFrom", "NonExistent"));
    }
    ...
    public void Constructor_WithNonDateTimeValidFrom_ThrowsArgumentException()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            new TemporalConfiguration(invalidProp));
    }
    ...
    public void Constructor_WithNonDateTimeValidTo_ThrowsArgumentException()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            new TemporalConfiguration(validFromProp, invalidValidTo));
    }

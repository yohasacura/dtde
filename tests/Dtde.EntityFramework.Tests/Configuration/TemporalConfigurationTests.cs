...
public class TemporalConfigurationTests
{
    ...
    {
        var config = TemporalConfiguration.Create<TemporalEntity>(
            e => e.ValidFrom,
            e => e.ValidTo);
    ...
    {
        var config = TemporalConfiguration.Create<TemporalEntity>("ValidFrom", "ValidTo");
    ...
    {
        var config = TemporalConfiguration.Create<TemporalEntity>("ValidFrom");
    ...
    public void Create_ThrowsForNonExistentProperty()
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            TemporalConfiguration.Create<TemporalEntity>("NonExistent", null));
